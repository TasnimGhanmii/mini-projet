...
function Homepage() {
  ...
  const handleimporterSessions = () => {
    navigate("/sessions");  // Rediriger vers la page Générer Surveillance
  };
  const handleimporterDevoirs = () => {
    navigate("/devoirs");  // Rediriger vers la page Générer Surveillance
  };
